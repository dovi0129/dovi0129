...
## About Me
산업/제조 공정에 강화학습과 디지털 트윈을 적용하는 연구 및 시스템 개발을 진행하고 있습니다.
...
- Indy7 + OpenMANIPULATOR-X 통신 및 제어  
  - Jetson Orin Nano, RealSense D455 기반 로봇 제어 스택 구성
...
| 기간 | 활동 | 내용 |
|---|---|---|
| 2025.11.19 ~ 2025.11.21 | 한국통신학회 추계종합학술발표회 | 강화학습 기반 제지 공정 초기 안정화 가속화 전략 발표 |
| 2025.10.16 | 교내 창의적 종합설계 경진대회 장려상 | 딥러닝 기반 딸기 숙성 분류 및 수확 자동화 로봇 |
| 2025.07.07 ~ | 산학협력 프로젝트 | 자율주행 주차로봇 운영 소프트웨어 성능 테스트 및 최적화 |
| 2024.07.08 ~ 2024.07.12 | 소중한 SW특강 | 코딩테스트 심화 및 알고리즘 교육 |
| 2024.01.08 ~ 2024.01.12 | 소중한 SW특강 | 정보보안 특강 및 정보보안기사 대비 교육 |
| 2024.01.22 ~ 2024.01.26 | 소중한 SW특강 | 코딩 역량 강화 및 알고리즘 교육 |
